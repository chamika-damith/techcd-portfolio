...
const Hero = () => {
  return (
    <section className="relative overflow-x-clip">
      ...
      <div className="px-container relative container mx-auto grid grid-cols-1 gap-[1em] py-[1em]">
        {/* Text area */}
        <div className="row-start-2 text-center">
          <p className="text-[13px] sm:text-[15.2px] md:text-[17.4px] lg:text-[20.7px] xl:text-[24px] 2xl:text-[27.3px]">
            JOIN THE EXCLUSIVE FAN
          </p>
          <p className="my-[0.4em] text-[36px] font-semibold sm:text-[41.2px] md:text-[46.4px] lg:text-[54.2px] xl:text-[62px] 2xl:text-[69.8px]">
            SUPPORT YOUR <br /> <span className="text-primary">FAVORITS</span>
            <br /> CREATOR ?
          </p>
          <p className="mb-[1em] text-[15px] sm:text-[17.2px] md:text-[19.4px] lg:text-[21.7px] xl:text-[24px] 2xl:text-[26.3px]">
            JOIN THE EXCLUSIVE FAN <br /> COUMMUNITY AND GRAB OFFICAL <br />{" "}
            MERCH
          </p>

          {/* CTA */}
          <div className="flex justify-center gap-[1.5em] text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[17px]">
            <button className="flex items-center gap-[0.8em] rounded-full rounded-tl-none border-[0.1em] ps-[1.5em]">
              JOIN THE FORUM
            ...
            <button className="rounded-full border-[0.1em] px-[2em]">
              SHOP NOW
            </button>
          </div>
        </div>
        ...
        {/* Image area */}
        <div className="relative mx-auto aspect-[134/117] w-3/4">
          <Image
            src={bitcoin}
            alt="Bitcoin Logo"
          ...
          <Image
            src={hero}
            alt="Hero"
            className="w-full rotate-y-180 object-cover object-center drop-shadow-[5px_5px_5px_#0000004d]"
          />
        </div>
      </div>
