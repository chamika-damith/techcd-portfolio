...
const DesktopCart: React.FC<DesktopCartProps> = ({
  ...
  return (
    <div className="px-container relative container mx-auto hidden lg:block">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="bg-foreground/10 overflow-hidden rounded-[0.6em] p-[1em] lg:col-span-2">
          ...
          {cartItems.map((item) => (
            ...
            >
              {/* Product Details */}
              <div className="flex flex-col items-center gap-[1em] text-center 2xl:flex-row 2xl:text-left">
