  ...
  return (
    <div ref={containerRef} className="relative z-[1] mt-[2em] sm:mt-0">
      ...
      <div
        ...
        className="bg-foreground translate-y-1/4 overflow-x-clip opacity-0 shadow-[0.1em_0.1em_0.5em_rgba(0,0,0,0.4)] lg:absolute lg:right-0 lg:bottom-0 lg:left-0"
      >
        <div
          id="banner-white"
              ...
              {Array.from({ length: bannerCount }).map((_, i) => (
                <div key={i} className="h-full">
                  <svg
                    ...
                    className="h-full"
                  >
                    <rect width="150" height="50" fill="var(--foreground)" />
                    <path
